...
switch($options[xPDOTransport::PACKAGE_ACTION]) {
    ...
    case xPDOTransport::ACTION_UPGRADE:
        ...
        if ($success) {
            ...
            $modx->log(xPDO::LOG_LEVEL_ERROR, 'Unfortunately, your server does not meet the minimum requirements for the Stripe gateways for SimpleCart and installation cannot continue.');
        }
